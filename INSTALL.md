...
|---|---|---|---|
| Fireside | среда | 05:07 | каждую неделю |
| This or That | пятница | 05:07 | каждую неделю |
| Weekly Theme | понедельник | 05:07 | каждую неделю |
...
Время сдвинуто с ровного часа (:07 вместо :00) — по опыту, `schedule`-триггеры GitHub Actions иногда пропускаются именно в пиковые "круглые" минуты из-за высокой нагрузки. Fireside/Weekly Theme/This or That поставлены на раннее утро (05:07 UTC), чтобы даже при задержке в несколько часов (тоже бывает у GitHub) пост всё равно успевал до конца рабочего дня.
